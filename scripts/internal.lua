...
function internal:initBroadcastHooks(tbl)
	...
	tbl.firePawnIsShieldedHooks =       self:buildBroadcastFunc("pawnIsShieldedHooks")
 	tbl.firePawnIsBoostedHooks =        self:buildBroadcastFunc("pawnIsBoostedHooks")
...
function internal:createDialogTables(tbl)
	...
	self:createIfMissing(tbl.ruledDialogs, "PawnBoosted")
	self:createIfMissing(tbl.ruledDialogs, "PawnUnBoosted")
