...
function modApiExt:internal_initGlobals()
	...
	if not v or (v ~= self.version and modApi:isVersion(v, self.version)) then
		...
		m.firePawnOnFireHooks =        self:buildBroadcastFunc("pawnOnFireHooks")
		m.firePawnExtinguishedHooks =  self:buildBroadcastFunc("pawnExtinguishedHooks")
		m.firePawnAcidedHooks =        self:buildBroadcastFunc("pawnAcidedHooks")
		m.firePawnUnacidedHooks =      self:buildBroadcastFunc("pawnUnacidedHooks")
		m.firePawnFrozenHooks =        self:buildBroadcastFunc("pawnFrozenHooks")
		m.firePawnUnfrozenHooks =      self:buildBroadcastFunc("pawnUnfrozenHooks")
		m.firePawnGrappledHooks =      self:buildBroadcastFunc("pawnGrappledHooks")
		m.firePawnUngrappledHooks =    self:buildBroadcastFunc("pawnUngrappledHooks")
		m.firePawnShieldedHooks =      self:buildBroadcastFunc("pawnShieldedHooks")
		m.firePawnUnshieldedHooks =    self:buildBroadcastFunc("pawnUnshieldedHooks")
